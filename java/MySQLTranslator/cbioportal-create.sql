CREATE EXTERNAL TABLE [another_type_of_cancer] (
  [foo] INTEGER
,  [bar] DATETIME
,  [decc] DECIMAL(10)
)with(location='cbioportal.another_type_of_cancer',data_source=mydsp016_nospace);
...
,  [NAME] NVARCHAR(255) NOT NULL
,  [DESCRIPTION] NVARCHAR(4000)
,  [SHOW_PROFILE_IN_ANALYSIS_TAB] BINARY NOT NULL
...
,  [END_POSITION] BIGINT
,  [REFERENCE_ALLELE] NVARCHAR(400)
,  [TUMOR_SEQ_ALLELE] NVARCHAR(400)
